...
Shader "Easy Outlines/Only Outline"
{
	Properties
	{
		...
		[ASEEnd][Toggle(_SCREENSPACE_ON)] _ScreenSpace("Screen Space", Float) = 0
		[HideInInspector][Toggle][ToggleUI]_Enabled("Enabled", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float3 staticSwitch14 = inputMesh.normalOS;
				#elif defined(_OUTLINETYPE_POSITION)
				float3 staticSwitch14 = inputMesh.positionOS;
				#elif defined(_OUTLINETYPE_UVBAKED)
				float3 staticSwitch14 = float3( inputMesh.ase_texcoord3.xy ,  0.0 );
				#else
				float3 staticSwitch14 = inputMesh.normalOS;
				#endif
				...
				#endif
				float3 vertexValue = ( _Enabled == 1.0 ? ( lerpResult7 * ( staticSwitch14 * _Thickness ) ) : float3( 0,0,0 ) );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float mulTime24 = _TimeParameters.x * _FlowSpeed;
				float2 temp_output_25_0 = ( appendResult2_g1 * mulTime24 );
				float2 texCoord26 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + temp_output_25_0;
				...
				#else
				float4 staticSwitch40 = float4( texCoord26, 0.0 , 0.0 );
				#endif
				...
				float4 staticSwitch33 = tex2D( _RampMap, temp_cast_3 );
				#else
				float4 staticSwitch33 = _OutlineColor;
				#endif
				
				surfaceDescription.Color = ( staticSwitch33 * _Intensity ).rgb;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float mulTime24 = _TimeParameters.x * _FlowSpeed;
				float2 temp_output_25_0 = ( appendResult2_g1 * mulTime24 );
				float2 texCoord26 = packedInput.ase_texcoord.xy * float2( 1,1 ) + temp_output_25_0;
...
/*ASEBEGIN
Version=19002
463;112;2189;1033;1722.95;483.5319;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-1194.93,105.4187;Inherit;False;Property;_AdaptiveThickness;Adaptive Thickness;0;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-1067.783,480.5561;Inherit;False;Property;_Thickness;Thickness;1;0;Create;True;0;0;0;False;0;False;0.01;0.009;0;0.3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;8;-424.5709,191.6228;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;58;-437.9858,66.41557;Inherit;False;Property;_Enabled;Enabled;12;3;[HideInInspector];[Toggle];[ToggleUI];Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;30;-476.7409,-434.1671;Inherit;False;Property;_Intensity;Intensity;6;0;Create;True;0;0;0;False;0;False;1;11680.84;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;23;-1636.144,-702.209;Inherit;False;DegreesToDirection;-1;;1;9699bea73387eb84cb4be675f1980d66;0;1;6;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;36;386.3547,-343.3898;Inherit;False;Property;_RampMapLoaded;RampMapLoaded;10;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;29;-692.7136,-642.1108;Inherit;True;Property;_RampMap;RampMap;4;1;[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;ec0703bb7ad0beb4781be833eefee57c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;-124.4409,-471.7671;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-2026.144,-565.209;Inherit;False;Property;_FlowSpeed;Flow Speed;8;0;Create;False;0;0;0;False;0;False;0.3647059;0.74;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;27;-1159.144,-509.2091;Inherit;False;Property;_NoiseScale;Noise Scale;7;0;Create;False;0;0;0;False;0;False;7.9;3.59;0;0;0;1;FLOAT;0
...
WireConnection;47;6;59;0
ASEEND*/
//CHKSM=B860D189E6094FE4F5CAAE58ABFDB22604EB07E2